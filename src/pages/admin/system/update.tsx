...
const SystemUpdate: React.FC<Props> = ({
  ...
  const [productName] = useState("nfxexchange");
  ...
  const externalNotesUrl = "https://support.nfxexchange.com/pages/5/update-notes";
  ...
  const noUpdateAvailable =
    !updateData.status &&
    updateData.message === "You have the latest version of nfxexchange.";
...
export async function getServerSideProps(context: any) {
  try {
    ...
    let updateData: UpdateData = {
      status: false,
      message: "You have the latest version of nfxexchange.",
      changelog: null,
      update_id: "",
