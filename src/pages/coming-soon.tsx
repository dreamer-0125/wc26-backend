          ...
          <div className="container">
            <div className="error-wrapper relative flex flex-col items-center justify-center overflow-hidden py-12">
              <div className="error-wrapper-inner relative isolate w-full">
                {/* <div className="underlay absolute left-1/2 top-[36%] -z-1 -translate-x-1/2 -translate-y-1/2 font-sans text-[4rem] font-extrabold text-muted-800 dark:text-muted-300 opacity-10 md:top-[38%] md:text-[10rem] ltablet:text-[12rem] lg:text-[16rem]">
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="mx-auto mb-4 max-w-lg text-base text-muted-500 dark:text-muted-400">{`${t(
                    "Something exciting is on the way! We're working hard behind the scenes. Stay tuned — launching soon!"
                  )}`}</p>
